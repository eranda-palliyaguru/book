		                               ...
		                               for($i=0; $row = $result->fetch(); $i++){			
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div id="cat"><input type="text" class="form-control" disabled>
                                                    </div>
                                                    <div id="new_cat"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="cat1"><input type="text" class="form-control" disabled>
                                                    </div>
                                                    <div id="new_cat1"></div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div id="cat2"><input type="text" class="form-control" disabled>
                                                    </div>
                                                    <div id="new_cat2"></div>
                                                </div>
                                            </div>
